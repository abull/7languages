...
myReverse([],[]).
myReverse([Head|Tail],Reverse) :- append(TailReverse,[Head],Reverse),
                                  myReverse(Tail, TailReverse).
...
smallest([Head|[]],Head).
smallest([Head|Tail],Head) :- smallest(Tail,TailSmallest),
                              TailSmallest >= Head.
smallest([Head|Tail],TailSmallest) :- smallest(Tail, TailSmallest),
                                      TailSmallest =< Head.
